...
access_control_group_list = TableDynamicLayout.set_fields('access_control_group_list', fields=[
...
cloud_db_server_instance_list = TableDynamicLayout.set_fields('cloud_db_server_instance_list', fields=[
