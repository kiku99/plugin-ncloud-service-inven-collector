...
'''
# TAB - Instance
cloud_db_instance = ItemDynamicLayout.set_fields('Instance', fields=[
...
# TAB - Configuration
cloud_db_configuration = ItemDynamicLayout.set_fields('Configuration', fields=[
...
# TAB - Connections
cloud_db_connection = ItemDynamicLayout.set_fields('Connection', fields=[
    TextDyField.data_source('Connection name', 'data.connection_name'),
...
# TAB - Database
cloud_db_database = TableDynamicLayout.set_fields('Database', 'data.databases', fields=[
...
# TAB - User
cloud_db_user = TableDynamicLayout.set_fields('User', 'data.users', fields=[
...
# TAB - Backup
cloud_db_backup = ItemDynamicLayout.set_fields('Backup', fields=[
