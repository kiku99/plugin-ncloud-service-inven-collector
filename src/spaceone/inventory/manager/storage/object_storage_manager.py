...
#from spaceone.inventory.connector.storage.monitoring import MonitoringConnector
from spaceone.inventory.model.storage.cloud_service_type import CLOUD_SERVICE_TYPES
from spaceone.inventory.model.storage.cloud_service import StorageResource, StorageResponse
from spaceone.inventory.model.storage.data import Storage
...
class ObjectStorageManager(NaverCloudManager):
    ...
    def collect_cloud_service(self, params):
        ...
        ##################################
        self.storage_conn: ObjectStorageConnector = self.locator.get_connector(self.connector_name, **params)
        ...
        buckets = self.storage_conn.list_buckets()
